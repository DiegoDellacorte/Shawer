    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 mt-5 animate__animated animate__fadeInRight animate__slow">
                <img class="seccion-img_dos d-block ms-auto" src="{{asset(Storage::url($seccionPlatos->img_dos))}}">
            </div>
            <div class="col-md-6 mt-5 animate__animated animate__fadeInRight animate__slow">
                <div class="seccion-titulo_texto"> {{$seccionPlatos->titulo}}</div>
                <div class="seccion-texto_descripcion">{!!$seccionPlatos->texto!!}</div>
            </div>
            <div class="col-md-6 animate__animated animate__fadeInLeft animate__slow">
                <img class="img-fluid seccion-img_dos me-auto d-md-block d-none" style="position: relative;z-index:1000;top:-120px" src="{{asset(Storage::url($seccionPlatos->img_uno))}}">
                <img class="img-fluid seccion-img_dos me-auto d-block d-md-none mb-5"  src="{{asset(Storage::url($seccionPlatos->img_uno))}}">
            </div>
        </div>
    </div>
     <!--Productos-->
        ...
        <div class="row">
            ...
            @foreach ($platos as $plato)
                <div class="col-md-4 mx-0 px-0 contenedor">
                    <a href="{{route('plato',$plato->id)}}" style="text-decoration:none">
                    <div  class="image" style="background-image: url({{asset(Storage::url($plato->img_principal))}});
                        background-repeat:no-repeat;
                        background-position:center;
                        height:316px">
