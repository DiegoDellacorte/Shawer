    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('proyectos.store')}}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-12">
                                <h6>Orden</h6>
                                ...
                                {!!$errors->first('tombre','<small class="text-danger">:message</small>')!!}
                                <h6>Texto</h6>
                            ...
                            <div class="col-md-6">
                                ...
                                <br>
                                <small class="text-muted">Resolución Recomendada 800px*572px</small>
                            </div>
                            <div class="col-md-6">
                                <h6>Imagen Dos</h6>
