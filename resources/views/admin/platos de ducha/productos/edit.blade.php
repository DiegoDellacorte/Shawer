            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <h6>Orden</h6>
                            <input type="text" class="form-control" name="orden" value="{{$plato->orden}}">
                            <h6>Titulo</h6>
                            <input type="text" class="form-control" name="titulo" value="{{$plato->titulo}}" >
                            <h6>Texto</h6>
                            <textarea name="texto">{!!$plato->texto!!}</textarea>
                            <h6>Imagen Uno</h6>
                            <img src="{{asset(Storage::url($plato->img_uno))}}" class="img-fluid">
                            <br>
                            <input type="file"  name="img1">
                            <br>
                            <small class="text-muted">Resolución Recomendada: 394px * 267px</small>
                            <h6>Imagen Dos</h6>
                            <img src="{{asset(Storage::url($plato->img_dos))}}" class="img-fluid">
                            <br>
                            <input type="file"  name="img2">
                            <br>
                            <small class="text-muted">Resolución Recomendada: 394px * 267px</small>
                            <h6>Imagen Principal</h6>
                            <img src="{{asset(Storage::url($plato->img_principal))}}" class="img-fluid">
                            <br>
                            <input type="file"  name="imgPrincipal">
                            <br>
                            <small class="text-muted">Resolución Recomendada: 1366px * 768px</small>
                            <h6>Tabla</h6>
                            <textarea name="tabla">{!!$plato->tabla!!}</textarea>
                        </div>
